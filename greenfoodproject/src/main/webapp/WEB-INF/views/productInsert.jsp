																...
																<div class="row">
																	<div class="col-lg-12 sm-margin-25px-bottom">
																		<div class="form-group">
																			...
																			name="product_image" id="product_image" accept="image/*" onchange="setThumbnail(event);"value="음식사진 선택" required>
																		</div>
												...
												<div class="row row-cols-1 row-cols-md-2"
													...
													<div class="col-lg-12 sm-margin-25px-bottom"
														...
														<a href="#" id="addIngredient"
															class="btn btn-fancy btn-small btn-gradient-tan-geraldine btn-round-edge margin-10px-bottom">사진 추가</a>
													</div>
												</div>
